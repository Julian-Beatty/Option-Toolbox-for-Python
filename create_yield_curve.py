...
def fed_yield_curve(fed_yield_curve,date_truncation="2021-11-01"):
...
def create_yield_curves(fed_yield_curve_filename,date_truncation="1980-01-02"):
    # Example usage
    fed_sheet = fed_yield_curve(fed_yield_curve_filename,date_truncation)
...
# spot,forward=create_yield_curves("fed_yield_curve.csv","2016-06-01")
